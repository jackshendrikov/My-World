...
from analyzer.operations.csv_importer import CSVImporter
...
def import_csv(request) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        if not filepath:
            ...
            return redirect(reverse("analyzer:import_csv"))
    ...
    return render(request, "analyzer/import_csv.html", context=ctx)
