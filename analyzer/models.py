...
class TaskList(models.Model):
    ...
    group = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='analyzer_group')
...
class Task(models.Model):
    ...
    def merge_into(self, merge_target):
        ...
        # the cascade clause
        with LockedAtomicTransaction(Commentary):
            Commentary.objects.filter(task=self).update(task=merge_target)
            self.delete()
